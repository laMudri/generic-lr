...
\begin{code}
    ...
    module WithSemantics
      ...
      (ι⟦_⟧ : BaseTy → WRel _≤ʷ_) (bang : Bang)
      where
...
\begin{code}
      ...
      Wrel .⟦con⟧ (`app (r , A) B , ≡.refl , m ✴ᶜ⟨ sp+ ⟩ (⟨ sp* ⟩·ᶜ n)) =
        uncurryᴿ (reify[] m)
          ∘ᴿ map-⊗ᴿ idᴿ (!ᴿ-map (reify[] n) ∘ᴿ ctx-* sp*)
          ∘ᴿ ctx-+ sp+
\end{code}
%</Wrel>
