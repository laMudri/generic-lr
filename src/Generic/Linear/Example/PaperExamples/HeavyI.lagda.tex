...
open CPP0 poSemiring hiding (_≤_; 0#; _+_; 1#; _*_; ≤-refl; +-identityʳ)
\end{code}

\begin{code}
pattern ⊸I M = `con (`⊸I _ _ , ≡.refl , M)
pattern !I sp M = `con (`!I _ _ , ≡.refl , ⟨ sp ⟩· M)
pattern !I′ P sp M = `con (`!I _ _ , ≡.refl , ⟨_⟩·_ {z = P} sp M)
pattern !E sp M N = `con (`!E _ _ _ , ≡.refl , M ✴⟨ sp ⟩ N)
pattern !E′ P Q sp M N = `con (`!E _ _ _ , ≡.refl , _✴⟨_⟩_ {y = P} {Q} M sp N)
